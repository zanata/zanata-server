...
public class ValidationService implements RunValidationEventHandler
{
   ...
   public void updateStatus(ValidationId key, boolean isEnabled, boolean fireRequestValidationEvent)
   {
      ...
      action.getInfo().setEnabled(isEnabled);
   ...
   public void updateValidationMessage(Map<ValidationInfo, List<String>> errors, boolean fireNotification,
         ArrayList<HasUpdateValidationWarning> widgetList)
   {
   ...
   private void updateConfigHolder()
   {
      ...
      {
         if (valAction.getInfo().isEnabled())
         {
