...
public interface TranslationService {
     ...
     */
    List<TranslationResult> translate(LocaleId localeId,
     ...
     * {@link TranslationResult} will report false for
     * isTranslationSuccessful(). This will not prevent other updates in
     * translationsToRevert being reverted.
     *
     * @param localeId
     * @param translationsToRevert
     *            describe each of the updates to be reverted
     * @return a list of results describing the outcome of each revert
     */
    List<TranslationResult> revertTranslations(LocaleId localeId,
     ...
     * @param iterationSlug
     *            The project iteration to translate
     * @param docId
     *            The document identifier to translate
     * @param locale
     *            The locale that the translations belong to
     * @param translations
     *            The translations to save to the document
     * @param extensions
     *            The extensions to use while translating
     * @param mergeType
