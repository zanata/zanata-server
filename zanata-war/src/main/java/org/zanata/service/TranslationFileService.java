...
public interface TranslationFileService {
    ...
    /**
     * Extract the translated strings from an adapter document file to a usable
     * form.
     *
     * @param tempFile
     *            the document to parse
     ...
     * version of an existing document file to a usable form.
     *
     * @param fileContents
     * @param docId
     ...
     *            format
     * @param offlinePo
     *            true to use msgctxt as the id for each text flow
