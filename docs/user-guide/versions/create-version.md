...
![Version creation button on a project homepage](images/version-create.gif)

Version creation button on a project homepage.

![Shortcut version creation link on user dashboard](images/user-dashboard-create-version.gif)
...
![Example version creation form with completed name and other settings](images/version-create-new.gif)
